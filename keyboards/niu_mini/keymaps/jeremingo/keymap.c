...
[_LOWER] = LAYOUT_ortho_4x12(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_HOME, KC_END,  S(KC_NUHS), S(KC_NUBS), _______,
...
[_RAISE] = LAYOUT_ortho_4x12(
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PGUP, KC_PGDN, KC_NUHS, KC_NUBS, _______,
  _______, _______, _______, _______, _______,     _______, _______,      _______, TD(TD_NXT_PRV), KC_VOLD, KC_VOLU, TD(TD_PLY_MUTE)
),

[_ADJUST] = LAYOUT_ortho_4x12(
  _______, RESET,   DEBUG,   KC_BRID, KC_BRIU, _______, _______, _______, _______,_______, _______, KC_DEL ,
